...
class AppThemeData{
  ...
  bool multiple = false;
  //
  bool extras = false; //  (false для foods и true для restaurants)
  //
  double radius = 4;
  int shadow = 5;
  //
  ...
  Color colorPrimary = Color(0xff66b88c); // foods 0xff66b88c // restaurants 0xff668798
  Color colorCompanion = Color(0xff029600); // foods 0xff029600 // restaurants 0xff009688
  //
